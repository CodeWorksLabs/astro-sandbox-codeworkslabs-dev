...
This repository builds a static Astro site for `https://astro.sandbox.codeworkslabs.dev/`. Wrangler reads `wrangler.jsonc` and targets the Cloudflare Worker configuration named `astro-sandbox-codeworkslabs-dev`.
